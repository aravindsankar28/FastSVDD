...
net.divideParam.trainRatio = size(train_data,1)/178;
  net.divideParam.valRatio = size(val_data,1)/178;
  net.divideParam.testRatio = size(test_data,1)/178;
  ...
  net.divideParam.testRatio = size(test_data,1)/178;
    ...
    (ac_val*size(val_data,1) + ac_test*size(test_data,1)) /(size(val_data,1) +size(test_data,1))
